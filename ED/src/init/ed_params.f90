...
subroutine init_pft_hydro_params()
   ...
   select case (plant_hydro_scheme)
      ...
      case(3)
         leaf_water_cap(17) = 3.e-3 * SLA(17) / C2B / MPa2m / 2.
         wood_water_cap(17) = min(400.,max(50.,                            &
                              -700. * (rho(17) - 0.3) + 400.))             &
                              / (rho(17) * 1.e3) / MPa2m / 3.

         leaf_water_sat(17) = 1.85
         wood_water_sat(17) = 0.7

         leaf_rwc_min(17) = 0.5
         wood_rwc_min(17) = 0.05


         leaf_psi_tlp(17)   = (-0.756 - 1.41 * rho(17)) * MPa2m
         wood_psi50(17)     = (0.32 - 3.28 * rho(17)) * MPa2m
         wood_Kmax(17)      = 10**(1.88 - 1.95 * rho(17)) / MPa2m
         wood_Kexp(17)      = 4.
